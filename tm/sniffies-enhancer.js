...
// @downloadURL  https://static.cinema-blue.icu/tm/sniffies-enhancer.js
// @updateURL    https://static.cinema-blue.icu/tm/sniffies-enhancer.js
...
(() => {
  ...
  GM_registerMenuCommand("Perform Action 1", function() {
    alert("Action 1 performed!");
  });

  GM_registerMenuCommand("Perform Action 2", function() {
  });
